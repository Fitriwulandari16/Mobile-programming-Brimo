        ...
        child: Column(children: [
          ...
          GridView.count(
            ...
            children: const [
              ...
              FeatureTile(imageUrl: 'assets/Brizzi.png', label: 'BRIZZI'),
              FeatureTile(imageUrl: 'assets/Tagihan.png', label: 'Tagihan', hasNotif: true),
              FeatureTile(imageUrl: 'assets/transfer.jpeg', label: 'Transfer'),
              FeatureTile(imageUrl: 'assets/Lifestyle.png', label: 'Lifestyle'),
              FeatureTile(imageUrl: 'assets/Setor.png', label: 'Setor & Tarik Tunai'),
              FeatureTile(imageUrl: 'assets/Catatan.png', label: 'Catatan Keuangan'),
              FeatureTile(imageUrl: 'assets/Investasi.png', label: 'Investasi'),
              FeatureTile(imageUrl: 'assets/Donasi.png', label: 'Donasi'),
              FeatureTile(imageUrl: 'assets/Virtual.png', label: 'Virtual Debit'),
              FeatureTile(imageUrl: 'assets/Kartu Kredit.png', label: 'Kartu Kredit', hasNotif: true),
              FeatureTile(imageUrl: 'assets/Asuransi.png', label: 'Asuransi'),
              FeatureTile(imageUrl: 'assets/Konversi Valas.png', label: 'Konversi Valas', hasNotif: true),
             ],
          ),
        ]),
      ),
